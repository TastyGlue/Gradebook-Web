        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_Profiles_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Grades_Profiles_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentParents_Profiles_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentParents_Profiles_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeacherSubjects_Profiles_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Timetables_Profiles_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Class_Year_Signature_SchoolId",
                table: "Classes",
                columns: new[] { "Year", "Signature", "SchoolId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolYear_SchoolId_Year_Semester",
                table: "SchoolYears",
                columns: new[] { "SchoolId", "Year", "Semester" },
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Absences_Profiles_StudentId",
                table: "Absences",
                column: "StudentId",
                principalTable: "Profiles",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Classes_Profiles_ClassTeacherId",
                table: "Classes",
                column: "ClassTeacherId",
                principalTable: "Profiles",
                principalColumn: "Id",
